...
public class ManagerAll extends BaseManager {
    ...
    public Call<List<Mahalleler>> ilanlarMahalleList(int sort, String baslik, String aciklama, int ilanturuid, int  kimdenid, String marka, String seri, String model, String minyil, String maxyil, String minkm, String maxkm, String motortipi, String motorHacmi, String minSurat, String maxSurat, String yakitTipi, String ortYakit, String depoHacmi, String minUcret, String maxUcret) {
      ...
      public Call<List<Iller>> ilanlarIlList(int sort, String baslik, String aciklama, int ilanturuid, int  kimdenid, ArrayList<String> mahallelerListIsSelected, String marka, String seri, String model, String minyil, String maxyil, String minkm, String maxkm, String motortipi, String motorHacmi, String minSurat, String maxSurat, String yakitTipi, String ortYakit, String depoHacmi, String minUcret, String maxUcret) {

        Call<List<Iller>>  a = getRestApi().ilanlarIllist(sort,baslik, aciklama, ilanturuid,  kimdenid,/*mahallelerListIsSelected,*/ marka, seri, model, minyil, maxyil, minkm, maxkm,motortipi, motorHacmi, minSurat, maxSurat, yakitTipi, ortYakit, depoHacmi, minUcret, maxUcret);
        return a;
    }
