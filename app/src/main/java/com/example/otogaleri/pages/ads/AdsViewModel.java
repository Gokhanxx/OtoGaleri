...
public class AdsViewModel extends ViewModel {
        ...
        ilanlist.enqueue(new Callback<List<Ilanlar>>() {
            ...
            public void onResponse(Call<List<Ilanlar>> call, Response<List<Ilanlar>> response) {
                if (response.isSuccessful()) {
                    ...
                    //Log.i("adsviewmodellogtest39",response.body().get(0).getResimbaslik());
    ...
    public void ilanlarlarIlList(int sort, String baslik, String aciklama, int ilanturuid, int  kimdenid, ArrayList<String> mahallelerListIsSelected, String marka, String seri, String model, String minyil, String maxyil, String minkm, String maxkm, String motortipi, String motorHacmi, String minSurat, String maxSurat, String yakitTipi, String ortYakit, String depoHacmi, String minUcret, String maxUcret) {
//        try {
            resultIlanlarilMessage = new MutableLiveData<>();
            resultIlanlarIlList = new MutableLiveData<>();
            Call<List<Iller>> ilanlarIllist = ManagerAll.getInstance().ilanlarIlList(sort,baslik,aciklama,ilanturuid, kimdenid,mahallelerListIsSelected,marka, seri, model, minyil, maxyil, minkm, maxkm, motortipi, motorHacmi, minSurat, maxSurat, yakitTipi, ortYakit, depoHacmi, minUcret, maxUcret);
            ilanlarIllist.enqueue(new Callback<List<Iller>>() {
                ...
                public void onResponse(Call<List<Iller>> call, Response<List<Iller>> response) {
                    if (response.isSuccessful()) {
                        ...
                        Log.i("adsviewmodellogtest109",response.body().toString());
